...
namespace Assets.ServerStubHome.Monsters
{
    public class RhinoVirus : IMonsterDna
    {
        ...
        public string NameKey { get { return MonsterList.RhinoVirus.ToString(); } }
